...
export class Ship {
    constructor(ctx, spritesheet, canvas) {
        ...
        this.image = new Object(spritesheet, {x: 441, y: 191}, 126, 108, 0.4);
    ...
    updateProjectiles(boolean) {
        this.projectiles.forEach((projectil, index) => {
            projectil.update(boolean);
            if(projectil.collision(this.canvas)) {
                setTimeout(() => {
    ...
    keyboard() {
        ...
        document.addEventListener("keyup", (e) => {
            ...
            if(e.key === "ArrowUp") this.keys.shoot = true;
        });
    }
}